...
exports.create = async (req, res) => {
	try {
		const userRoleType = await getUserRoleTypeFromToken(
...
exports.updateByFirebaseId = async (req, res) => {
	try {
		...
		if (userRoleType == 1) {
			await userModel
				.updateUserById(req.params.firebaseId, req.body)
				.then((firebaseResponse) => {
			...
			await userService
				.update(req.params.firebaseId, req.body)
				.then((firebaseResponse) => {
...
exports.deleteByFirebaseId = async (req, res) => {
	try {
		...
		if (userRoleType == 1) {
			...
			await userService
				.deleteByFirebaseId(req.params.firebaseId)
				.then((firebaseResponse) => {
